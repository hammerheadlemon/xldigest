...
from PyQt5.QtWidgets import (QApplication,
                             QWidget, QTreeView, QGroupBox, QVBoxLayout,
...
def createMailModel(parent=None):
    ...
    addMail(
        model, "Project/Programme Name", "Summary", "B3", QDate(2010, 8, 2))
    addMail(
        model, "SRO Sign-Off",  "Summary", "C4", QDate(2012, 12, 2))
    addMail(
        model, "SRO RAG Assessment", "Finance", "G212", QDate(2010, 2, 2))
    addMail(
        model, "Milestone 1", "Milestones", "C23", QDate(2014, 1, 21))
...
class FilterWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.sortCaseSensitivityCheckBox.toggled.connect(
            self.sortChanged)
        ...
        self.proxyLayout.addWidget(
            self.filterCaseSensitivityCheckBox, 4, 0, 1, 2)
    ...
    def filterRegExChanged(self):
        syntax = QRegExp.PatternSyntax(self.filterSyntaxCombo.itemData(
